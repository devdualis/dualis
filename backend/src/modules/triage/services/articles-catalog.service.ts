...
export class ArticlesCatalogService {
  private readonly articles: RecommendedArticleDto[] = [
    ...
    },
    {
      ...
      title: 'Falta de Ar vs. Ansiedade: Como Avaliar a Respiração no Dia a Dia',
      category: 'respiratorio',
      author: 'Dra. Clarissa Fontes',
      authorRole: 'Pneumologista (SBPT / CRM-SP 159.400)',
      readTimeMinutes: 4,
      summary:
        'Diferenciação clínica entre hiperventilação de fundo emocional e sintomas respiratórios obstrutivos.',
      url: 'https://dualis.health/artigos/falta-de-ar-e-ansiedade',
    },
    {
      id: 'art-superiores-01',
      title: 'Prevenção de LER/DORT e Tendinites em Membros Superiores',
      category: 'membros_superiores',
      author: 'Dr. Rodrigo Sanches',
      authorRole: 'Ortopedista e Cirurgião da Mão (CRM-SP 144.220)',
      readTimeMinutes: 5,
      summary:
        'Exercícios de alongamento para punhos, cotovelos e ombros para quem trabalha em computador.',
      url: 'https://dualis.health/artigos/prevencao-ler-dort-ombros-punhos',
    },
    {
      id: 'art-inferiores-01',
      title: 'Cuidados com Joelhos e Tornozelos: Evitando Lesões e Sobrecarga',
      category: 'membros_inferiores',
      author: 'Dr. Felipe Marcondes',
      authorRole: 'Ortopedista Especialista em Joelho (CRM-SP 138.650)',
      readTimeMinutes: 4,
      summary:
        'Fortalecimento muscular, calçados adequados e prevenção de dores articulares e tendíneas nos membros inferiores.',
      url: 'https://dualis.health/artigos/cuidados-com-joelhos-tornozelos',
    },
    {
      id: 'art-neuro-01',
      title: 'Tontura, Vertigem e Labirintite: Primeiros Passos e Diagnóstico',
      category: 'neurologico',
      author: 'Dra. Vanessa Meireles',
      authorRole: 'Neurologista Clínica (CRM-SP 162.190)',
      readTimeMinutes: 5,
      summary:
        'Entendendo a vertigem posicional benigna, labirintite e quando procurar um pronto-socorro neurológico.',
      url: 'https://dualis.health/artigos/tontura-vertigem-neurologia',
    },
    {
      id: 'art-pelvico-01',
      title: 'Saúde Pélvica e Sintomas Urinários: Prevenção e Orientações',
      category: 'geniturinario_pelvico',
      author: 'Dr. Gustavo Vianna',
      authorRole: 'Urologista (SBU / CRM-SP 135.780)',
      readTimeMinutes: 4,
      summary:
        'Hidratação adequada, sinais de infecção urinária e cuidados com o trato geniturinário.',
      url: 'https://dualis.health/artigos/saude-pelvica-sintomas-urinarios',
    },
    {
      id: 'art-dermato-01',
      title: 'Alergias Cutâneas e Dermatites: Como Identificar e Cuidar da Pele',
      category: 'dermatologico',
      author: 'Dra. Patricia Sampaio',
      authorRole: 'Dermatologista (SBD / CRM-SP 147.330)',
      readTimeMinutes: 4,
      summary:
        'Cuidados com a barreira cutânea, reações alérgicas comuns e proteção contra agentes irritantes.',
      url: 'https://dualis.health/artigos/alergias-cutaneas-e-dermatites',
    },
    {
      id: 'art-muscular-01',
      title: 'Mialgia Difusa e Cansaço Geral: Recuperação e Fatores Sistêmicos',
      category: 'muscular_geral_sistemico',
      author: 'Dr. André Cavalcanti',
      authorRole: 'Clínico Geral (SBCM / CRM-SP 134.800)',
      readTimeMinutes: 4,
      summary:
        'Como distinguir dores musculares por esforço de sintomas sistêmicos virais ou sobrecarga crônica.',
      url: 'https://dualis.health/artigos/mialgia-e-recuperacao-sistemica',
    },
    {
      id: 'art-endocrino-01',
      title: 'Sinais de Alerta Metabólico: Sede Excessiva, Energia e Oscilações',
      category: 'endocrino_metabolico',
      author: 'Dra. Renata Borges',
      authorRole: 'Endocrinologista (SBEM / CRM-SP 151.040)',
      readTimeMinutes: 5,
      summary:
        'Como alterações na glicemia, tireoide e metabolismo basal se manifestam na rotina diária.',
    ...
    {
      id: 'art-cognitiva-01',
      title: 'Brain Fog e Clareza Mental: Estratégias para Restaurar o Foco',
      category: 'cognitiva_foco',
      author: 'Dra. Mariana Fagundes',
      authorRole: 'Neuropsicóloga Clínica (CRP-06/98765)',
      readTimeMinutes: 5,
      summary:
        'Como pausas ativas, redução de multitarefas e sono regular combatem a névoa mental e melhoram a memória de trabalho.',
      url: 'https://dualis.health/artigos/clareza-mental-e-foco',
    },
    {
      id: 'art-autoestima-01',
      title: 'Autocompaixão e Manejo da Autocrítica Severa no Dia a Dia',
      category: 'autoestima',
      author: 'Dra. Isabela Duarte',
      authorRole: 'Psicóloga Especialista em Saúde Mental (CRP-06/87654)',
      readTimeMinutes: 4,
      summary:
        'Técnicas baseadas em Terapia Cognitivo-Comportamental para ressignificar pensamentos de incapacidade e culpa.',
